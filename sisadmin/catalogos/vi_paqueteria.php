...
<div class="card mb-3">
	<div class="card-header">
		<h5 class="card-title" style="float: left; margin-top: 5px;">LISTA DE PAQUETER&Iacute;AS</h5>
		...
		<div class="table-responsive">
			<table id="zero_config" class="table table-bordered table-hover" cellpadding="0" cellspacing="0">
				...
				<tbody>
					...
					<tr> 
   				  		<td style="text-align:center"><?php echo $result_paqueterias_row['idpaqueterias']; ?></td>  
					  	<td><?php echo  $result_paqueterias_row['nombre']; ?></td>
					  	<td><?php echo $result_paqueterias_row['direccion']; ?></td>
					  	<td><?php echo $result_paqueterias_row['tel']; ?></td>
					  	<td><?php echo $result_paqueterias_row['email']; ?></td>
						<td><?php echo $result_paqueterias_row['urlrastreo']; ?></td>
					  	<td><?php echo $estatus[$result_paqueterias_row['estatus']]; ?></td>
						<td align="center">
							
							<button type="button" onClick="aparecermodulos('catalogos/fa_paqueteria.php?idpaqueterias=<?php echo $result_paqueterias_row['idpaqueterias']; ?>','main');" title="EDITAR" class="btn btn-outline-info"><i class="mdi mdi-table-edit"></i></button>
							
							<button type="button" onClick="BorrarDatos(<?php echo $result_paqueterias_row['idpaqueterias']; ?>,'idpaqueterias','paqueterias','n','catalogos/vi_paqueteria.php','main')" title="BORRAR" class="btn btn-outline-danger"><i class="mdi mdi-delete-empty"></i></button>							
						</td> 
					</tr>
					<?php 
