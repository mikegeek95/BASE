	...
	<div class="card mb-3">
		...
		<div class="card-body">
			<div class="form-group m-t-20">
				...
				<input type="text" name="nombre" id="nombre" class="form-control" title="Campo Nombre del Proveedor" placeholder="nombre de la empresa" value="<?php echo $empresa; ?>" />
			</div>
			...
			<div class="form-group m-t-20">
				...
				<input type="text" name="telefono" id="telefono" class="form-control" title="Campo Tel&eacute;fono Del Proveedor" placeholder="9611234567" <?php echo $telefono; ?> />
			</div>
			
			<div class="form-group m-t-20">
				<label>E-mail:</label>
				<input type="text" name="email" id="email" class="form-control" title="Campo E-mail Del Proveedor" placeholder="email@ejemplo.com.mx" value="<?php echo $email; ?>" />
			</div>
			
			<div class="form-group m-t-20">
				<label>Contacto:</label>
				<input type="text" name="contacto" id="contacto" class="form-control" title="Campo Contacto Del Proveedor" placeholder="Nombre del Contacto" value="<?php echo 
				$contacto; ?>" />
			</div>
			
			<div class="form-group m-t-20">
				<label>URL:</label>
				<input type="text" name="url" id="url" class="form-control" title="URL" placeholder="Url del proveedor" value="<?php echo $url; ?>" />
			</div>
		</div>
