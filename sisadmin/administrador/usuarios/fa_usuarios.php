...
?>
	...
	<div class="card">
		...
		<div class="card-body">
			...
			<div class="form-group m-t-20">
				<label>NOMBRE :</label>
				<input type="text" name="nombre" id="nombre" class="form-control" title="Nombre" value="<?php echo $nombre; ?>" placeholder="Nombre" />
			</div>

			<div class="form-group m-t-20">
				<label>APELLIDO PATERNO:</label>
				<input type="text" name="paterno" id="paterno" class="form-control" title="Apellido Paterno" value="<?php echo $paterno; ?>" placeholder="Apellido Paterno" />
			</div>

			<div class="form-group m-t-20">
				<label>APELLIDO MATERNO:</label>
				<input type="text" name="materno" id="materno" class="form-control" title="Apellido Materno" value="<?php echo $materno; ?>" placeholder="Apellido Materno"/>
			</div>

			<div class="form-group m-t-20">
				<label>CELULAR:</label>
				 <input type="text" name="celular" id="celular" class="form-control" title="Celular" value="<?php echo $celular; ?>" placeholder="Celular" />
			</div>

			<div class="form-group m-t-20">
				<label>TEL&Eacute;FONO:</label>
				<input type="text" name="telefono" id="telefono" class="form-control" title="Tel&eacute;fono" value="<?php echo $telefono; ?>" placeholder="Tel&eacute;fono"/>
			</div>
			</div>
			<div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
			<div class="form-group m-t-20">
				<label>EMAIL:</label>
				<input type="text" name="email" id="email" class="form-control" title="Email" value="<?php echo $email; ?>" placeholder="Email" />
			</div>
				
			<div class="form-group m-t-20">
				<label>USUARIO:</label>
				<input onKeyPress="bloquear_enie (event.Keycode)" type="text" onBlur="var resp=MM_validateForm('usuario','','R'); if(resp==1){validarUsuario();}" name="usuario" id="usuario" class="form-control" title="Usuario" placeholder="Usuario" value="<?php echo $usuario; ?>" />
			...
			<div class="form-group m-t-20">
				<label>CLAVE:</label>
				<input type="password" name="clave" id="clave" class="form-control" title="Clave" value="<?php echo $clave; ?>" placeholder="Clave" />
			</div>
