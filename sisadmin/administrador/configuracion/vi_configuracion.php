...
<form name="f_configuracion" id="f_configuracion">
							...
							<div class="form-group m-t-20">
								...
								<div class="input-group">
												<div class="input-group-prepend">
													<span class="input-group-text" id="basic-addon1"><i class="fab fa-facebook-square"></i></i></span>
												  </div>
										...
										<div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-3">
											...
											<label>INSTAGRAM:</label>
												<div class="input-group">
												<div class="input-group-prepend">
													<span class="input-group-text" id="basic-addon1"><i class="fab fa-instagram"></i></i></span>
												  </div>
	...
	?>
					...
					<div class="form-group m-t-20">
						...
						<textarea name="v_cuentas" rows="4" class="form-control" id="v_cuentas"><?php echo $f->imprimir_cadena_utf8($row_configuracion['cuentasbancarias']);?></textarea>
					</div>
		...
		<div class="card-footer text-muted">
			...
			<button type="button" onClick="var resp=MM_validateForm('v_nombre_empresa','','R','v_direccion','','R','v_telefono','','R','v_email','','R','v_iva','','isNum','v_telefono','','isNum','v_email','','isEmail'); if(resp==1){ g_Configuracion();}" class="btn btn-outline-success alt_btn" style="float: right;" ><i class="far fa-save"></i> GUARDAR</button>
	  	</div>
	</div>
</form>
