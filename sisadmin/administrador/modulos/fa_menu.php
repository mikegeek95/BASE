...
?>
			...
			<div class="form-group m-t-20 col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
				...
				<input type="text" name="nombre" id="nombre" class="form-control" title="Nombre" placeholder="Nombre" value="<?php echo $menu; ?>" />
			</div>
			
			<div class="form-group m-t-20 col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
				<label>Nombre del Archivo:</label>
				<input type="text" name="archivo" id="archivo" class="form-control" title="Archivo" placeholder="Archivo" value="<?php echo $archivo; ?>" />
			</div>
			
			<div class="form-group m-t-20 col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
				<label>Ubicacion del Archivo:</label>
				<input type="text" name="ubi" id="ubi" class="form-control" title="Ubicaci&oacute;n del Archivo" placeholder="Ubicaci&oacute;n de Archivo" value="<?php echo $ubicacion; ?>" />
			</div>
			
			<div class="form-group m-t-20 col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
				<label>Nivel en el Orden:</label>
				<input type="text" name="nivel" id="nivel" class="form-control" title="Nivel de Orden" placeholder="0" value="<?php echo $nivel; ?>" />
			</div>
