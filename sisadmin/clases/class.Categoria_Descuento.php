...
class categoria_descuento
{
	...
	{
		$sql = "INSERT INTO categoria_precios_niveles (idcategoria_precio,idniveles,descuento) VALUES ('$this->idcategoria_precio','$this->idniveles','$this->desc');";
		$resp = $this->db->consulta($sql);
	...
	{
		$sql = "INSERT INTO categoria_precio (nombre,estatus) VALUES ('$this->nombre
		','$this->estatus');";
		$resp = $this->db->consulta($sql);
